...
$sql="select * from Amistad where Usuario1='maic1'";
                ...
                <div class="chat-history">
                    <ul class="m-b-0">
                        <li class="clearfix">
                            ...
                            <div class="message other-message float-right">Hola como estas?</div>
                        </li>
                        <li class="clearfix">
                            <div class="message-data">
                                <span class="message-data-time">10:12 AM, Today</span>
                            </div>
                            <div class="message my-message">Q te valga vrga :c</div>                                    
                        </li>                               
                        <li class="clearfix">
                            <div class="message-data">
