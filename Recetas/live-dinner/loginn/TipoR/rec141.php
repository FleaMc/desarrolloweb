...
$instruccion="Update TiposR set TipoReceta= '{$_POST['usuario1']}', Descripcion='{$_POST['desc2']}' where TipoReceta='$recant'";
if (strcmp ($nombrearchivo1, '' ) == 0) 
{
echo   "<br>No se selecciono foto a modificar<br>";
    
}else{
$instruccion="Update TiposR set Imagen='$ruta$nombrearchivo1' where TipoReceta='$recant'"; 
    }
