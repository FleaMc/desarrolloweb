...
$instruccion="insert into Chef(Nombre,Poblacion,Pais,Correo,Genero)values
('{$_POST['nombre1']}','{$_POST['poblacion1']}','{$_POST['pais1']}','{$_POST['correo1']}','{$_POST['genero1']}')";

$r=mysqli_query($c,$instruccion);   

if($r == 1){
$instruccion2="insert into Admin(Nombre,Usuario,Clave,Tipo)values
